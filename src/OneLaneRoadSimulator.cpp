...
OneLaneRoadSimulator::OneLaneRoadSimulator(int car_portion, int bus_portion, int truck_portion, int arrival_interval,
                                           int max_speed_ms, int road_length_m)
...
void OneLaneRoadSimulator::simulate(int seconds, float speed_up_ratio = 1) {
...
void OneLaneRoadSimulator::reset() {
